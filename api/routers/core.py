...
def events_search(
    ...
    if len(q) == 0:
        return {"data": []}
    if live:
        return assist.autocomplete(
            project_id=projectId, q=q, key=key if key is not None else type
        )
    ...
    result = events.search(
        text=q, event_type=type, project_id=projectId, source=source, key=key
    )
    return result
...
def get_integrations_status(
    ...
    data = integrations_global.get_global_integrations_status(
        tenant_id=context.tenant_id, user_id=context.user_id, project_id=projectId
    )
    return {"data": data}
...
def add_edit_sentry(
    ...
    return {
        "data": log_tool_sentry.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def delete_sentry(
    projectId: int, _=Body(None), context: schemas.CurrentContext = Depends(OR_context)
):
    return {
        "data": log_tool_sentry.delete(
            tenant_id=context.tenant_id, project_id=projectId
        )
    }
...
def proxy_sentry(
    projectId: int, eventId: str, context: schemas.CurrentContext = Depends(OR_context)
):
    return {
        "data": log_tool_sentry.proxy_get(
            tenant_id=context.tenant_id, project_id=projectId, event_id=eventId
        )
    }
...
def add_edit_datadog(
    ...
    return {
        "data": log_tool_datadog.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def add_edit_stackdriver(
    ...
    return {
        "data": log_tool_stackdriver.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def delete_stackdriver(
    projectId: int, _=Body(None), context: schemas.CurrentContext = Depends(OR_context)
):
    return {
        "data": log_tool_stackdriver.delete(
            tenant_id=context.tenant_id, project_id=projectId
        )
    }
...
def add_edit_newrelic(
    ...
    return {
        "data": log_tool_newrelic.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def add_edit_rollbar(
    ...
    return {
        "data": log_tool_rollbar.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def add_edit_bugsnag(
    ...
    return {
        "data": log_tool_bugsnag.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def add_edit_cloudwatch(
    ...
    return {
        "data": log_tool_cloudwatch.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def delete_cloudwatch(
    ...
    return {
        "data": log_tool_cloudwatch.delete(
            tenant_id=context.tenant_id, project_id=projectId
        )
    }
...
def add_edit_elasticsearch(
    ...
    return {
        "data": log_tool_elasticsearch.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def delete_elasticsearch(
    ...
    return {
        "data": log_tool_elasticsearch.delete(
            tenant_id=context.tenant_id, project_id=projectId
        )
    }
...
def add_edit_sumologic(
    ...
    return {
        "data": log_tool_sumologic.add_edit(
            tenant_id=context.tenant_id, project_id=projectId, data=data
        )
    }
...
def delete_sumologic(
    projectId: int, _=Body(None), context: schemas.CurrentContext = Depends(OR_context)
):
    return {
        "data": log_tool_sumologic.delete(
            tenant_id=context.tenant_id, project_id=projectId
        )
    }
...
def delete_default_issue_tracking_tool(
    _=Body(None), context: schemas.CurrentContext = Depends(OR_context)
):
    error, integration = integrations_manager.get_integration(
        tenant_id=context.tenant_id, user_id=context.user_id
    )
...
def get_integration_metadata(
    integrationProjectId: int, context: schemas.CurrentContext = Depends(OR_context)
):
    error, integration = integrations_manager.get_integration(
        tenant_id=context.tenant_id, user_id=context.user_id
    )
...
def add_metadata(
    ...
    return metadata.add(
        tenant_id=context.tenant_id, project_id=projectId, new_name=data.key
    )
...
def delete_metadata(
    ...
    return metadata.delete(
        tenant_id=context.tenant_id, project_id=projectId, index=index
    )
...
def search_metadata(
    ...
    return metadata.search(
        tenant_id=context.tenant_id, project_id=projectId, value=q, key=key
    )
...
def get_alerts_triggers(
    projectId: int, context: schemas.CurrentContext = Depends(OR_context)
):
    return {
        "data": alerts.get_predefined_values()
        + custom_metrics.get_series_for_alert(
...
def get_alert(
    projectId: int, alertId: int, context: schemas.CurrentContext = Depends(OR_context)
):
...
def sign_sourcemap_for_upload(
    ...
    return {
        "data": sourcemaps.presign_upload_urls(
            project_id=context.project.project_id, urls=data.urls
        )
    }
...
def edit_weekly_report_config(
    ...
    return {
        "data": weekly_report.edit_config(
            user_id=context.user_id, weekly_report=data.weekly_report
        )
    }
...
def mobile_signe(
    ...
    return {
        "data": mobile.sign_keys(
            project_id=projectId, session_id=sessionId, keys=data.keys
        )
    }
...
def create_project(
    ...
    return projects.create(
        tenant_id=context.tenant_id, user_id=context.user_id, data=data
    )
...
@app.put(
    "/projects/{projectId}", tags=["projects"], dependencies=[OR_role("owner", "admin")]
)
def edit_project(
    projectId: int,
    data: schemas.CreateProjectSchema = Body(...),
...
def get_notifications_count(context: schemas.CurrentContext = Depends(OR_context)):
    return {
        "data": notifications.get_all_count(
            tenant_id=context.tenant_id, user_id=context.user_id
        )
    }
...
def view_notifications(
    notificationId: int, context: schemas.CurrentContext = Depends(OR_context)
):
    return {
        "data": notifications.view_notification(
            notification_ids=[notificationId], user_id=context.user_id
        )
    }
...
def get_slack_channels(context: schemas.CurrentContext = Depends(OR_context)):
    return {
        "data": webhook.get_by_type(
            tenant_id=context.tenant_id, webhook_type=schemas.WebhookType.slack
        )
    }
...
def get_slack_webhook(
    integrationId: int, context: schemas.CurrentContext = Depends(OR_context)
):
    return {
        "data": Slack.get_integration(
...
def add_edit_webhook(
    ...
    return {
        "data": webhook.add_edit(
            tenant_id=context.tenant_id, data=data, replace_none=True
        )
    }
...
def get_webhooks(context: schemas.CurrentContext = Depends(OR_context)):
    return {
        "data": webhook.get_by_tenant(tenant_id=context.tenant_id, replace_none=True)
    }


@app.delete("/webhooks/{webhookId}", tags=["webhooks"])
def delete_webhook(
    webhookId: int, _=Body(None), context: schemas.CurrentContext = Depends(OR_context)
):
...
def reset_reinvite_member(
    memberId: int, context: schemas.CurrentContext = Depends(OR_context)
):
...
def delete_member(
    memberId: int, _=Body(None), context: schemas.CurrentContext = Depends(OR_context)
):
    return users.delete_member(
        tenant_id=context.tenant_id, user_id=context.user_id, id_to_delete=memberId
    )


@app.get(
    "/account/new_api_key", tags=["account"], dependencies=[OR_role("owner", "admin")]
)
...
def get_saved_searches(
    ...
    return {
        "data": saved_search.get_all(
            project_id=projectId, user_id=context.user_id, details=True
        )
    }
...
def get_saved_search(
    ...
    return {
        "data": saved_search.get(
            project_id=projectId, search_id=search_id, user_id=context.user_id
        )
    }
...
def delete_saved_search(
    ...
    return {
        "data": saved_search.delete(
            project_id=projectId, user_id=context.user_id, search_id=search_id
        )
    }
...
def get_msteams_channels(context: schemas.CurrentContext = Depends(OR_context)):
    return {
        "data": webhook.get_by_type(
            tenant_id=context.tenant_id, webhook_type=schemas.WebhookType.msteams
        )
    }
...
def edit_msteams_integration(
    ...
    if len(data.url.unicode_string()) > 0:
        old = MSTeams.get_integration(
            tenant_id=context.tenant_id, integration_id=webhookId
        )
        if not old:
...
def delete_msteams_integration(
    webhookId: int, _=Body(None), context: schemas.CurrentContext = Depends(OR_context)
):
    return webhook.delete(tenant_id=context.tenant_id, webhook_id=webhookId)
...
def tags_delete(
    projectId: int, tagId: int, context: schemas.CurrentContext = Depends(OR_context)
):
